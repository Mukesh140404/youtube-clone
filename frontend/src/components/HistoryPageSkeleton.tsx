      ...
      <div className="space-y-10">
        ...
        {[1, 2, 3].map((groupIndex) => (
          <div key={groupIndex}>
            ...
            <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 gap-y-8">
              {Array.from({ length: 5 }).map((_, i) => ( // 5 video cards per row for desktop
